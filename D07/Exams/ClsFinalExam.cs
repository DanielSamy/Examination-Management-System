namespace D07.Exams
{
    public class ClsFinalExam : ClsExam
    {
        public override string ExamType => "Final";
        public ClsFinalExam(short time, ClsQuestionList questionList, ClsSubject subject) : base(time, questionList, subject) { }
